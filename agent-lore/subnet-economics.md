...
### Methodology
1. Maps the full tokenomic incentive structure — validators, miners, end users, team
2. Models Nash equilibria and identifies perverse incentives
3. Assesses value accrual: does the token actually capture value from the network?
4. Evaluates governance mechanisms and upgrade paths
