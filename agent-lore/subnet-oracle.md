...
### Methodology
1. Cross-references on-chain data against project claims
2. Verifies team wallet activity and token distribution
3. Checks for fake volume, wash trading, and artificial metrics
4. Scores honesty of project communications (1-10)
